...
class MVK54531(Fmi3Slave):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.register_variable(
            Boolean("PinBased", causality=Fmi3Causality.parameter, variability=Fmi3Variability.tunable,
                    description="Pin based mapping of inputs"))
        self.register_variable(
            Boolean("PortBased", causality=Fmi3Causality.parameter, variability=Fmi3Variability.tunable,
                    description="Port based mapping of inputs"))
        self.register_variable(
            Boolean("ComplexBased", causality=Fmi3Causality.parameter, variability=Fmi3Variability.tunable,
                    description="Complex based mapping of inputs"))
        ...
        self.register_variable(
            Int32("outByte1", causality=Fmi3Causality.output, description="To PLC: Sensor bits converted to Integer"))
        self.register_variable(
            Int32("outByte2", causality=Fmi3Causality.output, description="To PLC: Sensor bits converted to Integer"))
        ...
        self.register_variable(Int32("inByte2", causality=Fmi3Causality.input,
                                     description="From PLC: Integer value to set the actuators from the module"))
        self.register_variable(Int32("actuator_short_circuit_trigger_value", causality=Fmi3Causality.input,
                                     description="Short circuit can be triggered by changing values from 255 to 0-255"))
        self.register_variable(Int32("sensor_short_circuit_trigger_value", causality=Fmi3Causality.input,
    ...
    def do_step(self, current_time, step_size):
        ...
        self.outByte1, self.outByte2 = digital_inputs(
            np.array([self.X4_2, self.X4_4, self.X5_2, self.X5_4, self.X6_2, self.X6_4, self.X7_2, self.X7_4]),
            self.PinBased, self.PortBased, self.ComplexBased)
        ...
        self.X0_2, self.X0_4, self.X1_2, self.X1_4, self.X2_2, self.X2_4, self.X3_2, self.X3_4 = digital_outputs(
            self.inByte1, self.inByte2, self.PinBased, self.PortBased, self.ComplexBased)
        ...
        [short_circuit_actuator_trigger_as_bits, short_circuit_sensor_trigger_as_bits] = short_circuit_trigger(
            self.sensor_short_circuit_trigger_value, self.actuator_short_circuit_trigger_value)

        # Qualifier DI. These outputs from block are connected to PLC
        self.qualifier_di_8_byte1, self.qualifier_di_8_byte2 = qualifier_di_8(short_circuit_sensor_trigger_as_bits,
                                                                              self.PinBased, self.PortBased,
                                                                              self.ComplexBased)

        # Qualifier DO.  These outputs from block are connected to PLC
        self.qualifier_do_8_byte1, self.qualifier_do_8_byte2 = qualifier_do_8(self.inByte1, self.inByte2,
        ...
        self.system_state_byte_1, self.system_state_byte_2, self.system_state_byte_3, self.system_state_byte_4 = System_State(
            self.qualifier_di_8_byte1, self.qualifier_di_8_byte2, self.qualifier_do_8_byte1, self.qualifier_do_8_byte2,
            "false", "false", self.Sensor_Voltage, self.Actuator_Voltage)
